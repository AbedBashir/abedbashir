...
const Contact = () => {
  ...
  const sendEmail = (e) => {
    ...
    emailjs.sendForm('service_o8mvcue', 'template_se1x42b', form.current, '1Gw7x9mDdnr2JoUOI')
      e.target.reset();
    };
  return (
        ...
        <div className="contact__content">
          ...
          <div className="contact__info">
            <div className="contact__card">
              ...
              <span className="contact__card-data">devabedbashir@gmail.com</span>

              <a href="mailto:devabedbashir@gmail.com" target="_blank" className="contact__button">Email me <i className="bx bx-right-arrow-alt contact__button-icon"></i></a>
            </div>
            ...
            <div className="contact__card">
              ...
              <span className="contact__card-data">+(961) 81-713 782 </span>

              <a href="https://wa.me/81713782" target="_blank" className="contact__button">Contact me <i className="bx bx-right-arrow-alt contact__button-icon"></i></a>
            </div>
            ...
            <div className="contact__card">
              ...
              <span className="contact__card-data">Abed Bashir</span>

              <a href="https://www.linkedin.com/in/abdel-rahman-bashir-952732208/" target="_blank" className="contact__button">Find me <i className="bx bx-right-arrow-alt contact__button-icon"></i></a>
            </div>
          </div>
        </div>
        <div className="contact__content">
